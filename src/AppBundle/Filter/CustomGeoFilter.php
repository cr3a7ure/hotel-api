...
use AppBundle\Filter\FilterHelp\AbstractFilter as MyAbstractFilter;
use Unirest;
 ...
 */
class CustomGeoFilter extends MyAbstractFilter
{
    /**
    ...
    public function __construct(RequestStack $requestStack, IriConverterInterface $iriConverter, PropertyAccessorInterface $propertyAccessor = null, LoggerInterface $logger = null, array $properties = null)
    {
        parent::__construct($requestStack, $logger, $properties);
